...
msgend:
    ; Almacena los datos en los registros
    mov dx, 0xCF75 ; 16 bits mas significativos del código de alumno
    mov cx, 0 ; 16 bits menos significativos del código de alumno
    mov bx, 0 ; 16 bits mas significativos del NRC del curso
    mov ax, 0 ; 16 bits menos significativos del NRC del curso
        mov ah,0
        int 16h
        int 20h
